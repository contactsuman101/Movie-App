...
<section class="container mx-auto p-6 font-mono">
          ...
          <tbody class="bg-white">
              ...
              <tr class="text-gray-700">
                ...
                <td>
                    ...
                    <x-m-button wire:click='showDeleteModal({{ $tag->id }})' class="bg-red-500 hover:bg-red-700 text-white">Delete</x-m-button>
                </td>
    ...
    <x-jet-dialog-modal wire:model="showTagModal">
        ...
        <x-slot name="content"><div class="mt-10 sm:mt-0">
        ...
        <x-slot name="footer">
            ...
            @if ($tagId)
            <x-m-button wire:click="updateTag">Update Tag</x-m-button>
            @else
            <x-m-button wire:click="createTag">Create Tag</x-m-button>
            @endif
